...
def get_args():
    ...
    parser.add_argument("--city", help="The city name you want to generate GPS coordinates from", default='Central Delhi', type=str) # required=True
    parser.add_argument("--country", help="The country name you want to generate GPS coordinates from", default='India', type=str) # required=True
